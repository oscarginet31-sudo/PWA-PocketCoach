...
Projet : Application Web Progressive (PWA) de Fitness Version : 4.1 Technologie : Vanilla JS / Bootstrap 5 / PWA Date : Février 2026
...
Installation (Pre-Cache) : Lors de la première visite, l'intégralité des fichiers statiques (HTML, CSS, JS, Polices) est téléchargée et stockée dans le cache du navigateur (caches.open).
...
Mode Sombre (Dark Mode) : Implémentation d'un thème sombre natif pour réduire la consommation d'énergie sur les écrans OLED.
...
Historique : Création d'une page dédiée pour historiser les séances passées indexées par date.
